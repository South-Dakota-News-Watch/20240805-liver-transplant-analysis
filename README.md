...
This repository includes a [code notebook](liver-transplant-findings.ipynb) and supporting documentation below to reproduce the findings about liver transplants in ["Alcohol's impact: 35, dry and dying while waiting for a transplant,"](https://www.sdnewswatch.org/chronic-liver-disease-cirrhosis-killing-south-dakota-30-year-olds/) an article by Megan Luther published Aug. 5, 2024, for South Dakota News Watch. Cody Winchester analyzed the data.
